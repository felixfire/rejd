...
def reform(schema: Dict, data: Any, initial_data: Any = None) -> Dict:
    """
    ...
    if type_fn == dict:
        ...
        if schema is not None:
            ...
            for field, field_schema in schema.items():
                result_obj[field] = reform(field_schema, matched_data, initial_data)
        else:
        ...
        if schema is not None:
            ...
            for item in matched_data:
                result_obj.append(reform(schema, item, initial_data))
